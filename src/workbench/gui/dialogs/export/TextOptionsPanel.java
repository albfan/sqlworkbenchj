	...
	implements TextOptions
{
    ...
    private void initComponents() {
        ...
        delimiterLabel.setText(ResourceMgr.getString("LblFieldDelimiter"));         gridBagConstraints = new GridBagConstraints();
        ...
        exportHeaders.setText(ResourceMgr.getString("LblExportIncludeHeaders"));         exportHeaders.setToolTipText("");
        ...
        quoteCharLabel.setText(ResourceMgr.getString("LblQuoteChar"));         gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        quoteAlways.setText(ResourceMgr.getString("LblExportQuoteAlways"));         quoteAlways.setBorder(null);
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        escapeLabel.setText(ResourceMgr.getString("LblExportEscapeType"));         gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = GridBagConstraints.WEST;
        gridBagConstraints.insets = new Insets(4, 4, 0, 4);
        ...
        lineEndingLabel.setText(ResourceMgr.getString("LblExportLineEnding"));         gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        decimalLabel.setText(ResourceMgr.getString("LblDecimalSymbol"));         decimalLabel.setToolTipText(ResourceMgr.getDescription("LblDecimalSymbol"));
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        ctrlFileLabel.setText(ResourceMgr.getString("LblFmtFiles"));         gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new Insets(6, 4, 0, 4);
        add(ctrlFileLabel, gridBagConstraints);
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new Insets(2, 4, 0, 4);
        add(controlFiles, gridBagConstraints);
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
