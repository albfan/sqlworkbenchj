	...
	implements Restoreable, ActionListener, Disposable
{
	...
	public GeneralOptionsPanel()
	{
		...
		if (!brushedMetal.isVisible())
		{
			...
			GridBagConstraints constraints = layout.getConstraints(wheelZoom);
			constraints.weightx = 1.0;
			layout.setConstraints(wheelZoom, constraints);
		}
  ...
  private void initComponents()
  {
    ...
    jPanel2.add(wheelZoom, gridBagConstraints);
    ...
    gridBagConstraints.insets = new Insets(2, 12, 2, 15);
    ...
    gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
    gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
    gridBagConstraints.insets = new Insets(2, 7, 0, 10);
    ...
    gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
    gridBagConstraints.anchor = GridBagConstraints.SOUTHWEST;
    gridBagConstraints.insets = new Insets(5, 12, 0, 15);
