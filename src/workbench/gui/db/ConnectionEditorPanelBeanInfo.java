...
public class ConnectionEditorPanelBeanInfo extends SimpleBeanInfo
{
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        EventSetDescriptor[] eventSets = new EventSetDescriptor[13];
            ...
            try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" );
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" );
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" );
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" );
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" );
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" );
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" );
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" );
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" );
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" );
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" );
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" );
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( workbench.gui.db.ConnectionEditorPanel.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" );
        }
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_updateUI0] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("updateUI", new Class[] {}));
            methods[METHOD_updateUI0].setDisplayName ( "" );
            methods[METHOD_update1] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("update", new Class[] {java.awt.Graphics.class}));
            methods[METHOD_update1].setDisplayName ( "" );
            methods[METHOD_paint2] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("paint", new Class[] {java.awt.Graphics.class}));
            methods[METHOD_paint2].setDisplayName ( "" );
            methods[METHOD_printAll3] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("printAll", new Class[] {java.awt.Graphics.class}));
            methods[METHOD_printAll3].setDisplayName ( "" );
            methods[METHOD_print4] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("print", new Class[] {java.awt.Graphics.class}));
            methods[METHOD_print4].setDisplayName ( "" );
            methods[METHOD_requestFocus5] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("requestFocus", new Class[] {}));
            methods[METHOD_requestFocus5].setDisplayName ( "" );
            methods[METHOD_requestFocus6] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("requestFocus", new Class[] {Boolean.TYPE}));
            methods[METHOD_requestFocus6].setDisplayName ( "" );
            methods[METHOD_requestFocusInWindow7] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("requestFocusInWindow", new Class[] {}));
            methods[METHOD_requestFocusInWindow7].setDisplayName ( "" );
            methods[METHOD_grabFocus8] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("grabFocus", new Class[] {}));
            methods[METHOD_grabFocus8].setDisplayName ( "" );
            methods[METHOD_contains9] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("contains", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_contains9].setDisplayName ( "" );
            methods[METHOD_getInsets10] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getInsets", new Class[] {java.awt.Insets.class}));
            methods[METHOD_getInsets10].setDisplayName ( "" );
            methods[METHOD_registerKeyboardAction11] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("registerKeyboardAction", new Class[] {java.awt.event.ActionListener.class, java.lang.String.class, javax.swing.KeyStroke.class, Integer.TYPE}));
            methods[METHOD_registerKeyboardAction11].setDisplayName ( "" );
            methods[METHOD_registerKeyboardAction12] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("registerKeyboardAction", new Class[] {java.awt.event.ActionListener.class, javax.swing.KeyStroke.class, Integer.TYPE}));
            methods[METHOD_registerKeyboardAction12].setDisplayName ( "" );
            methods[METHOD_unregisterKeyboardAction13] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("unregisterKeyboardAction", new Class[] {javax.swing.KeyStroke.class}));
            methods[METHOD_unregisterKeyboardAction13].setDisplayName ( "" );
            methods[METHOD_getConditionForKeyStroke14] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getConditionForKeyStroke", new Class[] {javax.swing.KeyStroke.class}));
            methods[METHOD_getConditionForKeyStroke14].setDisplayName ( "" );
            methods[METHOD_getActionForKeyStroke15] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getActionForKeyStroke", new Class[] {javax.swing.KeyStroke.class}));
            methods[METHOD_getActionForKeyStroke15].setDisplayName ( "" );
            methods[METHOD_resetKeyboardActions16] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("resetKeyboardActions", new Class[] {}));
            methods[METHOD_resetKeyboardActions16].setDisplayName ( "" );
            methods[METHOD_setInputMap17] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("setInputMap", new Class[] {Integer.TYPE, javax.swing.InputMap.class}));
            methods[METHOD_setInputMap17].setDisplayName ( "" );
            methods[METHOD_getInputMap18] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getInputMap", new Class[] {Integer.TYPE}));
            methods[METHOD_getInputMap18].setDisplayName ( "" );
            methods[METHOD_getInputMap19] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getInputMap", new Class[] {}));
            methods[METHOD_getInputMap19].setDisplayName ( "" );
            methods[METHOD_requestDefaultFocus20] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("requestDefaultFocus", new Class[] {}));
            methods[METHOD_requestDefaultFocus20].setDisplayName ( "" );
            methods[METHOD_getDefaultLocale21] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getDefaultLocale", new Class[] {}));
            methods[METHOD_getDefaultLocale21].setDisplayName ( "" );
            methods[METHOD_setDefaultLocale22] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("setDefaultLocale", new Class[] {java.util.Locale.class}));
            methods[METHOD_setDefaultLocale22].setDisplayName ( "" );
            methods[METHOD_getToolTipText23] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getToolTipText", new Class[] {java.awt.event.MouseEvent.class}));
            methods[METHOD_getToolTipText23].setDisplayName ( "" );
            methods[METHOD_getToolTipLocation24] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getToolTipLocation", new Class[] {java.awt.event.MouseEvent.class}));
            methods[METHOD_getToolTipLocation24].setDisplayName ( "" );
            methods[METHOD_createToolTip25] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("createToolTip", new Class[] {}));
            methods[METHOD_createToolTip25].setDisplayName ( "" );
            methods[METHOD_scrollRectToVisible26] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("scrollRectToVisible", new Class[] {java.awt.Rectangle.class}));
            methods[METHOD_scrollRectToVisible26].setDisplayName ( "" );
            methods[METHOD_enable27] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("enable", new Class[] {}));
            methods[METHOD_enable27].setDisplayName ( "" );
            methods[METHOD_disable28] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("disable", new Class[] {}));
            methods[METHOD_disable28].setDisplayName ( "" );
            methods[METHOD_getClientProperty29] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getClientProperty", new Class[] {java.lang.Object.class}));
            methods[METHOD_getClientProperty29].setDisplayName ( "" );
            methods[METHOD_putClientProperty30] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("putClientProperty", new Class[] {java.lang.Object.class, java.lang.Object.class}));
            methods[METHOD_putClientProperty30].setDisplayName ( "" );
            methods[METHOD_isLightweightComponent31] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("isLightweightComponent", new Class[] {java.awt.Component.class}));
            methods[METHOD_isLightweightComponent31].setDisplayName ( "" );
            methods[METHOD_reshape32] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("reshape", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_reshape32].setDisplayName ( "" );
            methods[METHOD_getBounds33] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getBounds", new Class[] {java.awt.Rectangle.class}));
            methods[METHOD_getBounds33].setDisplayName ( "" );
            methods[METHOD_getSize34] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getSize", new Class[] {java.awt.Dimension.class}));
            methods[METHOD_getSize34].setDisplayName ( "" );
            methods[METHOD_getLocation35] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getLocation", new Class[] {java.awt.Point.class}));
            methods[METHOD_getLocation35].setDisplayName ( "" );
            methods[METHOD_computeVisibleRect36] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("computeVisibleRect", new Class[] {java.awt.Rectangle.class}));
            methods[METHOD_computeVisibleRect36].setDisplayName ( "" );
            methods[METHOD_firePropertyChange37] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Byte.TYPE, Byte.TYPE}));
            methods[METHOD_firePropertyChange37].setDisplayName ( "" );
            methods[METHOD_firePropertyChange38] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Character.TYPE, Character.TYPE}));
            methods[METHOD_firePropertyChange38].setDisplayName ( "" );
            methods[METHOD_firePropertyChange39] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Short.TYPE, Short.TYPE}));
            methods[METHOD_firePropertyChange39].setDisplayName ( "" );
            methods[METHOD_firePropertyChange40] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_firePropertyChange40].setDisplayName ( "" );
            methods[METHOD_firePropertyChange41] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Long.TYPE, Long.TYPE}));
            methods[METHOD_firePropertyChange41].setDisplayName ( "" );
            methods[METHOD_firePropertyChange42] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Float.TYPE, Float.TYPE}));
            methods[METHOD_firePropertyChange42].setDisplayName ( "" );
            methods[METHOD_firePropertyChange43] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Double.TYPE, Double.TYPE}));
            methods[METHOD_firePropertyChange43].setDisplayName ( "" );
            methods[METHOD_firePropertyChange44] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("firePropertyChange", new Class[] {java.lang.String.class, Boolean.TYPE, Boolean.TYPE}));
            methods[METHOD_firePropertyChange44].setDisplayName ( "" );
            methods[METHOD_addPropertyChangeListener45] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("addPropertyChangeListener", new Class[] {java.lang.String.class, java.beans.PropertyChangeListener.class}));
            methods[METHOD_addPropertyChangeListener45].setDisplayName ( "" );
            methods[METHOD_removePropertyChangeListener46] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("removePropertyChangeListener", new Class[] {java.lang.String.class, java.beans.PropertyChangeListener.class}));
            methods[METHOD_removePropertyChangeListener46].setDisplayName ( "" );
            methods[METHOD_getPropertyChangeListeners47] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getPropertyChangeListeners", new Class[] {java.lang.String.class}));
            methods[METHOD_getPropertyChangeListeners47].setDisplayName ( "" );
            methods[METHOD_getListeners48] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getListeners", new Class[] {java.lang.Class.class}));
            methods[METHOD_getListeners48].setDisplayName ( "" );
            methods[METHOD_addNotify49] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("addNotify", new Class[] {}));
            methods[METHOD_addNotify49].setDisplayName ( "" );
            methods[METHOD_removeNotify50] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("removeNotify", new Class[] {}));
            methods[METHOD_removeNotify50].setDisplayName ( "" );
            methods[METHOD_repaint51] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("repaint", new Class[] {Long.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_repaint51].setDisplayName ( "" );
            methods[METHOD_repaint52] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("repaint", new Class[] {java.awt.Rectangle.class}));
            methods[METHOD_repaint52].setDisplayName ( "" );
            methods[METHOD_revalidate53] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("revalidate", new Class[] {}));
            methods[METHOD_revalidate53].setDisplayName ( "" );
            methods[METHOD_paintImmediately54] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("paintImmediately", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_paintImmediately54].setDisplayName ( "" );
            methods[METHOD_paintImmediately55] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("paintImmediately", new Class[] {java.awt.Rectangle.class}));
            methods[METHOD_paintImmediately55].setDisplayName ( "" );
            methods[METHOD_countComponents56] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("countComponents", new Class[] {}));
            methods[METHOD_countComponents56].setDisplayName ( "" );
            methods[METHOD_insets57] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("insets", new Class[] {}));
            methods[METHOD_insets57].setDisplayName ( "" );
            methods[METHOD_add58] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("add", new Class[] {java.awt.Component.class}));
            methods[METHOD_add58].setDisplayName ( "" );
            methods[METHOD_add59] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("add", new Class[] {java.lang.String.class, java.awt.Component.class}));
            methods[METHOD_add59].setDisplayName ( "" );
            methods[METHOD_add60] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("add", new Class[] {java.awt.Component.class, Integer.TYPE}));
            methods[METHOD_add60].setDisplayName ( "" );
            methods[METHOD_add61] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("add", new Class[] {java.awt.Component.class, java.lang.Object.class}));
            methods[METHOD_add61].setDisplayName ( "" );
            methods[METHOD_add62] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("add", new Class[] {java.awt.Component.class, java.lang.Object.class, Integer.TYPE}));
            methods[METHOD_add62].setDisplayName ( "" );
            methods[METHOD_remove63] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("remove", new Class[] {Integer.TYPE}));
            methods[METHOD_remove63].setDisplayName ( "" );
            methods[METHOD_remove64] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("remove", new Class[] {java.awt.Component.class}));
            methods[METHOD_remove64].setDisplayName ( "" );
            methods[METHOD_removeAll65] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("removeAll", new Class[] {}));
            methods[METHOD_removeAll65].setDisplayName ( "" );
            methods[METHOD_doLayout66] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("doLayout", new Class[] {}));
            methods[METHOD_doLayout66].setDisplayName ( "" );
            methods[METHOD_layout67] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("layout", new Class[] {}));
            methods[METHOD_layout67].setDisplayName ( "" );
            methods[METHOD_invalidate68] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("invalidate", new Class[] {}));
            methods[METHOD_invalidate68].setDisplayName ( "" );
            methods[METHOD_validate69] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("validate", new Class[] {}));
            methods[METHOD_validate69].setDisplayName ( "" );
            methods[METHOD_preferredSize70] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("preferredSize", new Class[] {}));
            methods[METHOD_preferredSize70].setDisplayName ( "" );
            methods[METHOD_minimumSize71] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("minimumSize", new Class[] {}));
            methods[METHOD_minimumSize71].setDisplayName ( "" );
            methods[METHOD_paintComponents72] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("paintComponents", new Class[] {java.awt.Graphics.class}));
            methods[METHOD_paintComponents72].setDisplayName ( "" );
            methods[METHOD_printComponents73] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("printComponents", new Class[] {java.awt.Graphics.class}));
            methods[METHOD_printComponents73].setDisplayName ( "" );
            methods[METHOD_deliverEvent74] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("deliverEvent", new Class[] {java.awt.Event.class}));
            methods[METHOD_deliverEvent74].setDisplayName ( "" );
            methods[METHOD_getComponentAt75] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getComponentAt", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_getComponentAt75].setDisplayName ( "" );
            methods[METHOD_locate76] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("locate", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_locate76].setDisplayName ( "" );
            methods[METHOD_getComponentAt77] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getComponentAt", new Class[] {java.awt.Point.class}));
            methods[METHOD_getComponentAt77].setDisplayName ( "" );
            methods[METHOD_findComponentAt78] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("findComponentAt", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_findComponentAt78].setDisplayName ( "" );
            methods[METHOD_findComponentAt79] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("findComponentAt", new Class[] {java.awt.Point.class}));
            methods[METHOD_findComponentAt79].setDisplayName ( "" );
            methods[METHOD_isAncestorOf80] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("isAncestorOf", new Class[] {java.awt.Component.class}));
            methods[METHOD_isAncestorOf80].setDisplayName ( "" );
            methods[METHOD_list81] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("list", new Class[] {java.io.PrintStream.class, Integer.TYPE}));
            methods[METHOD_list81].setDisplayName ( "" );
            methods[METHOD_list82] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("list", new Class[] {java.io.PrintWriter.class, Integer.TYPE}));
            methods[METHOD_list82].setDisplayName ( "" );
            methods[METHOD_areFocusTraversalKeysSet83] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("areFocusTraversalKeysSet", new Class[] {Integer.TYPE}));
            methods[METHOD_areFocusTraversalKeysSet83].setDisplayName ( "" );
            methods[METHOD_isFocusCycleRoot84] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("isFocusCycleRoot", new Class[] {java.awt.Container.class}));
            methods[METHOD_isFocusCycleRoot84].setDisplayName ( "" );
            methods[METHOD_transferFocusBackward85] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("transferFocusBackward", new Class[] {}));
            methods[METHOD_transferFocusBackward85].setDisplayName ( "" );
            methods[METHOD_transferFocusDownCycle86] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("transferFocusDownCycle", new Class[] {}));
            methods[METHOD_transferFocusDownCycle86].setDisplayName ( "" );
            methods[METHOD_applyComponentOrientation87] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("applyComponentOrientation", new Class[] {java.awt.ComponentOrientation.class}));
            methods[METHOD_applyComponentOrientation87].setDisplayName ( "" );
            methods[METHOD_enable88] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("enable", new Class[] {Boolean.TYPE}));
            methods[METHOD_enable88].setDisplayName ( "" );
            methods[METHOD_enableInputMethods89] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("enableInputMethods", new Class[] {Boolean.TYPE}));
            methods[METHOD_enableInputMethods89].setDisplayName ( "" );
            methods[METHOD_show90] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("show", new Class[] {}));
            methods[METHOD_show90].setDisplayName ( "" );
            methods[METHOD_show91] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("show", new Class[] {Boolean.TYPE}));
            methods[METHOD_show91].setDisplayName ( "" );
            methods[METHOD_hide92] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("hide", new Class[] {}));
            methods[METHOD_hide92].setDisplayName ( "" );
            methods[METHOD_getLocation93] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getLocation", new Class[] {}));
            methods[METHOD_getLocation93].setDisplayName ( "" );
            methods[METHOD_location94] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("location", new Class[] {}));
            methods[METHOD_location94].setDisplayName ( "" );
            methods[METHOD_setLocation95] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("setLocation", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_setLocation95].setDisplayName ( "" );
            methods[METHOD_move96] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("move", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_move96].setDisplayName ( "" );
            methods[METHOD_setLocation97] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("setLocation", new Class[] {java.awt.Point.class}));
            methods[METHOD_setLocation97].setDisplayName ( "" );
            methods[METHOD_getSize98] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getSize", new Class[] {}));
            methods[METHOD_getSize98].setDisplayName ( "" );
            methods[METHOD_size99] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("size", new Class[] {}));
            methods[METHOD_size99].setDisplayName ( "" );
            methods[METHOD_setSize100] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("setSize", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_setSize100].setDisplayName ( "" );
            methods[METHOD_resize101] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("resize", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_resize101].setDisplayName ( "" );
            methods[METHOD_setSize102] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("setSize", new Class[] {java.awt.Dimension.class}));
            methods[METHOD_setSize102].setDisplayName ( "" );
            methods[METHOD_resize103] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("resize", new Class[] {java.awt.Dimension.class}));
            methods[METHOD_resize103].setDisplayName ( "" );
            methods[METHOD_bounds104] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("bounds", new Class[] {}));
            methods[METHOD_bounds104].setDisplayName ( "" );
            methods[METHOD_setBounds105] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("setBounds", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_setBounds105].setDisplayName ( "" );
            methods[METHOD_getFontMetrics106] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("getFontMetrics", new Class[] {java.awt.Font.class}));
            methods[METHOD_getFontMetrics106].setDisplayName ( "" );
            methods[METHOD_paintAll107] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("paintAll", new Class[] {java.awt.Graphics.class}));
            methods[METHOD_paintAll107].setDisplayName ( "" );
            methods[METHOD_repaint108] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("repaint", new Class[] {}));
            methods[METHOD_repaint108].setDisplayName ( "" );
            methods[METHOD_repaint109] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("repaint", new Class[] {Long.TYPE}));
            methods[METHOD_repaint109].setDisplayName ( "" );
            methods[METHOD_repaint110] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("repaint", new Class[] {Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_repaint110].setDisplayName ( "" );
            methods[METHOD_imageUpdate111] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("imageUpdate", new Class[] {java.awt.Image.class, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_imageUpdate111].setDisplayName ( "" );
            methods[METHOD_createImage112] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("createImage", new Class[] {java.awt.image.ImageProducer.class}));
            methods[METHOD_createImage112].setDisplayName ( "" );
            methods[METHOD_createImage113] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("createImage", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_createImage113].setDisplayName ( "" );
            methods[METHOD_createVolatileImage114] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("createVolatileImage", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_createVolatileImage114].setDisplayName ( "" );
            methods[METHOD_createVolatileImage115] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("createVolatileImage", new Class[] {Integer.TYPE, Integer.TYPE, java.awt.ImageCapabilities.class}));
            methods[METHOD_createVolatileImage115].setDisplayName ( "" );
            methods[METHOD_prepareImage116] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("prepareImage", new Class[] {java.awt.Image.class, java.awt.image.ImageObserver.class}));
            methods[METHOD_prepareImage116].setDisplayName ( "" );
            methods[METHOD_prepareImage117] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("prepareImage", new Class[] {java.awt.Image.class, Integer.TYPE, Integer.TYPE, java.awt.image.ImageObserver.class}));
            methods[METHOD_prepareImage117].setDisplayName ( "" );
            methods[METHOD_checkImage118] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("checkImage", new Class[] {java.awt.Image.class, java.awt.image.ImageObserver.class}));
            methods[METHOD_checkImage118].setDisplayName ( "" );
            methods[METHOD_checkImage119] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("checkImage", new Class[] {java.awt.Image.class, Integer.TYPE, Integer.TYPE, java.awt.image.ImageObserver.class}));
            methods[METHOD_checkImage119].setDisplayName ( "" );
            methods[METHOD_inside120] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("inside", new Class[] {Integer.TYPE, Integer.TYPE}));
            methods[METHOD_inside120].setDisplayName ( "" );
            methods[METHOD_contains121] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("contains", new Class[] {java.awt.Point.class}));
            methods[METHOD_contains121].setDisplayName ( "" );
            methods[METHOD_dispatchEvent122] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("dispatchEvent", new Class[] {java.awt.AWTEvent.class}));
            methods[METHOD_dispatchEvent122].setDisplayName ( "" );
            methods[METHOD_postEvent123] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("postEvent", new Class[] {java.awt.Event.class}));
            methods[METHOD_postEvent123].setDisplayName ( "" );
            methods[METHOD_handleEvent124] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("handleEvent", new Class[] {java.awt.Event.class}));
            methods[METHOD_handleEvent124].setDisplayName ( "" );
            methods[METHOD_mouseDown125] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("mouseDown", new Class[] {java.awt.Event.class, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_mouseDown125].setDisplayName ( "" );
            methods[METHOD_mouseDrag126] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("mouseDrag", new Class[] {java.awt.Event.class, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_mouseDrag126].setDisplayName ( "" );
            methods[METHOD_mouseUp127] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("mouseUp", new Class[] {java.awt.Event.class, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_mouseUp127].setDisplayName ( "" );
            methods[METHOD_mouseMove128] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("mouseMove", new Class[] {java.awt.Event.class, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_mouseMove128].setDisplayName ( "" );
            methods[METHOD_mouseEnter129] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("mouseEnter", new Class[] {java.awt.Event.class, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_mouseEnter129].setDisplayName ( "" );
            methods[METHOD_mouseExit130] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("mouseExit", new Class[] {java.awt.Event.class, Integer.TYPE, Integer.TYPE}));
            methods[METHOD_mouseExit130].setDisplayName ( "" );
            methods[METHOD_keyDown131] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("keyDown", new Class[] {java.awt.Event.class, Integer.TYPE}));
            methods[METHOD_keyDown131].setDisplayName ( "" );
            methods[METHOD_keyUp132] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("keyUp", new Class[] {java.awt.Event.class, Integer.TYPE}));
            methods[METHOD_keyUp132].setDisplayName ( "" );
            methods[METHOD_action133] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("action", new Class[] {java.awt.Event.class, java.lang.Object.class}));
            methods[METHOD_action133].setDisplayName ( "" );
            methods[METHOD_gotFocus134] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("gotFocus", new Class[] {java.awt.Event.class, java.lang.Object.class}));
            methods[METHOD_gotFocus134].setDisplayName ( "" );
            methods[METHOD_lostFocus135] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("lostFocus", new Class[] {java.awt.Event.class, java.lang.Object.class}));
            methods[METHOD_lostFocus135].setDisplayName ( "" );
            methods[METHOD_transferFocus136] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("transferFocus", new Class[] {}));
            methods[METHOD_transferFocus136].setDisplayName ( "" );
            methods[METHOD_nextFocus137] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("nextFocus", new Class[] {}));
            methods[METHOD_nextFocus137].setDisplayName ( "" );
            methods[METHOD_transferFocusUpCycle138] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("transferFocusUpCycle", new Class[] {}));
            methods[METHOD_transferFocusUpCycle138].setDisplayName ( "" );
            methods[METHOD_hasFocus139] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("hasFocus", new Class[] {}));
            methods[METHOD_hasFocus139].setDisplayName ( "" );
            methods[METHOD_add140] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("add", new Class[] {java.awt.PopupMenu.class}));
            methods[METHOD_add140].setDisplayName ( "" );
            methods[METHOD_remove141] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("remove", new Class[] {java.awt.MenuComponent.class}));
            methods[METHOD_remove141].setDisplayName ( "" );
            methods[METHOD_toString142] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("toString", new Class[] {}));
            methods[METHOD_toString142].setDisplayName ( "" );
            methods[METHOD_list143] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("list", new Class[] {}));
            methods[METHOD_list143].setDisplayName ( "" );
            methods[METHOD_list144] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("list", new Class[] {java.io.PrintStream.class}));
            methods[METHOD_list144].setDisplayName ( "" );
            methods[METHOD_list145] = new MethodDescriptor ( workbench.gui.db.ConnectionEditorPanel.class.getMethod("list", new Class[] {java.io.PrintWriter.class}));
