...
public class CmdLineParser
{
	...
	public static class IllegalOptionValueException extends OptionException
	{
		public IllegalOptionValueException( Option opt, String value )
		{
			...
			opt.getShortForm() + "/--" + opt.getLongForm());
			this.option = opt;
			this.value = value;
		}
	...
	{
		return values.get(o.getLongForm());
	}
		...
		throws IllegalOptionValueException, UnknownOptionException
	{
		...
		while ( position < argv.length )
		{
			...
			if ( curArg.startsWith("-") || curArg.startsWith("/") )
			{
				...
				this.values.put(opt.getLongForm(), value);
				position += 1;
			}
			else
			{
	...
	public static void main( String[] args )
	{
		...
		CmdLineParser.Option profile = parser.addStringOption('p', "profile");
		CmdLineParser.Option script = parser.addStringOption('s', "script");
		...
		String theProfile = (String)parser.getOptionValue(profile);
		
		System.out.println("profile: " + theProfile);
		System.out.println("script: " + (String)parser.getOptionValue(script));
