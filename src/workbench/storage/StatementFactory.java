...
public class StatementFactory
{
	...
	private boolean includeAllInsertColumns;
	private boolean skipIdentityCols;
	...
	public StatementFactory(ResultInfo metaData, WbConnection conn)
	{
		...
		skipIdentityCols = Settings.getInstance().getGenerateInsertIgnoreIdentity();
	}

	public void setSkipIdentityColumnsForInsert(boolean skip)
	{
		this.skipIdentityCols = skip;
	}
	...
	{
		if (includeAllInsertColumns) return true;
