...
public interface TriggerReader {
	...
	String[] LIST_COLUMNS = {TriggerReader.TRIGGER_NAME_COLUMN, TriggerReader.TRIGGER_TYPE_COLUMN, TriggerReader.TRIGGER_EVENT_COLUMN, TriggerReader.TRIGGER_TABLE_COLUMN, TriggerReader.TRIGGER_COMMENT_COLUMN};
