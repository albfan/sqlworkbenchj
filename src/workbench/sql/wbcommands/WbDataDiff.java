			...
			try
			{
				...
				if (xmlOutput)
				{
					...
					for (int i=0; i < tableCount; i++)
					{
						...
						out.write("      <reference-table>" + refTable.getTableName() + "</reference-table>" + nl);
						out.write("      <target-table>" + targetTable.getTableName() + "</target-table>" + nl);
						out.write("    </mapping>" + nl);
					}
				...
				else
				{
					...
					{
						out.write("-- " + table.getTableName() + nl);
					}
					out.write("--" + nl);
					out.write("-- Generated by " + ResourceMgr.TXT_PRODUCT_NAME + " at: " + StringUtil.getCurrentTimestampWithTZString() + nl);
					out.write(line.toString());
