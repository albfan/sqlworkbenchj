	...
	public void testMultiLineLiteral()
	{
        ...
        "AND   http_status IN ('200')";			
			...
			int[][] expectedTokens = new int[][]
			{
				...
				{Token.OPERATOR, Token.NULL, Token.OPERATOR, Token.NULL, Token.LITERAL1 }, // AND name = ...
				{Token.OPERATOR, Token.NULL, Token.OPERATOR, Token.NULL, Token.LITERAL1 }, // AND col = ...
				{Token.OPERATOR, Token.NULL, Token.KEYWORD1, Token.NULL, Token.KEYWORD1, Token.NULL, Token.KEYWORD1, Token.NULL, Token.KEYWORD1, Token.NULL} , // AND filename ...
				{Token.OPERATOR, Token.NULL, Token.KEYWORD1, Token.NULL, Token.NULL, Token.LITERAL1, Token.NULL} // AND htpp ...
			};
